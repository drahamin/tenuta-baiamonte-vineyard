...
def ensure_new_defaults(values: dict) -> dict:
    ...
    defaults = {
        ...
        "prediction_sources_minutes": 180,
...
mapping = {
    ...
    "cistern_rtsp_url": "CISTERN_RTSP_URL",
    "vineyard_north_rtsp_url": "VINEYARD_NORTH_RTSP_URL",
    ...
    "prediction_sources_minutes": "PREDICTION_SOURCES_MINUTES",
    "external_public_location_queries_enabled": "EXTERNAL_PUBLIC_LOCATION_QUERIES_ENABLED",
    "sentinel_public_processing_enabled": "SENTINEL_PUBLIC_PROCESSING_ENABLED",
