...
from .domains.enology_process import router as enology_process_router
...
app = FastAPI(title="Baiamonte Vineyard API", version=addon_version(), lifespan=lifespan)
...
app.include_router(enology_process_router)
