...
from .domains.messaging import event_payload as _event_payload
...
from .intelligence import CISTERN_SNAPSHOT_PATH, ProcessAlreadyRunningError, alert_preference, analyze_intake, analyze_observation_attachment, ask_assistant, check_openai_service, current_home_assistant_presence, fit_disease_pressure_model, home_assistant_local_only_user_ids, home_assistant_manager_camera_catalog, home_assistant_people, home_assistant_state_map, integration_loop, mark_power_monitor_stopped, poll_gmail_once, power_continuity_heartbeat, power_continuity_loop, predict_next_treatment, refresh_treatment_weather_learning, resolve_condition_alert, run_full_refresh, run_named_process, save_intake_file, whatsapp_templates
...
app = FastAPI(title="Baiamonte Vineyard API", version="1.6.55", lifespan=lifespan)
