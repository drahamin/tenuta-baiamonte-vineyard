...
class Settings(BaseSettings):
    ...
    gmail_allowed_senders: str = "laboratorio@cimalab.it,gabrielefedericistudio@gmail.com,david@rahamins.com"
    ...
    twilio_public_reception_enabled: bool = True
    twilio_pstn_enabled: bool = False
    twilio_pstn_phone_number_sids: str = ""
    twilio_sip_enabled: bool = False
    twilio_sip_domain_sids: str = ""
    twilio_outbound_enabled: bool = False
    twilio_outbound_caller_id: str = ""
    twilio_forwarding_enabled: bool = False
    twilio_forwarding_target: str = ""
    twilio_account_sid: str = ""
    twilio_auth_token: str = ""
    twilio_api_key_sid: str = ""
    twilio_api_key_secret: str = ""
    twilio_voice_application_sid: str = ""
    twilio_whatsapp_sender_sid: str = ""
