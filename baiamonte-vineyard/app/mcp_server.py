...
WRITE_RECORDS: dict[str, dict[str, Any]] = {
    ...
    "spray_application": {"table": "spray_applications", "fields": {"application_date", "purpose", "area_ha", "water_volume_l", "operator_name", "equipment_name", "temp_c", "wind_kph", "status", "notes", "block_id", "source_application_id", "evidence_status", "actual_details_confirmed", "agronomist_approved", "label_legal_confirmed", "phi_checked", "rei_checked", "weather_checked", "ppe_confirmed"}, "required": {"application_date", "purpose"}, "defaults": {"status": "planned", "actual_details_confirmed": 0, "agronomist_approved": 0, "label_legal_confirmed": 0, "phi_checked": 0, "rei_checked": 0, "weather_checked": 0, "ppe_confirmed": 0}},
}
