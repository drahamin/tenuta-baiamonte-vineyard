...
(function () {
  ...
  function renderSolar(data) {
    const solar = data.solar || {}, snap = data.snapshot || {}, bank = data.battery_bank || {}, model = data.learning || {}, settings = data.settings || {}, power = Object.fromEntries((data.power || []).map(row => [row.code, row]));
