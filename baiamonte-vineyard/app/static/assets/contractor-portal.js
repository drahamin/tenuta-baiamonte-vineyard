...
(function(){
  ...
  function renderContractorPortal(){
    ...
    document.getElementById('contractorMetrics').innerHTML=[
      metric('Confirmed water deliveries',String(delivery.confirmed_deliveries||0),`${Number(delivery.pending_claims||0)} awaiting evidence`),
