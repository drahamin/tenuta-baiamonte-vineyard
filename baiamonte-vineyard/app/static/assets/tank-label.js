  ...
  try {
    ...
    document.getElementById("labelBody").innerHTML = `
      ...
      <div class="fields">
        ...
        <div class="field wide field-detail"><small>Responsabile / contatto di cantina</small><strong>${value(d.responsible_operator || d.cantiniere_name || d.cantiniere)}</strong><span>${d.cantiniere_name ? `${esc(d.cantiniere_name)} · ` : ""}${value(d.cantiniere_telephone)}</span></div>
