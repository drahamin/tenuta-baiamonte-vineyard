...
def save_quick_entry(record_type: str, supplied: dict[str, Any]) -> dict[str, Any]:
    ...
    record_id = new_id()
    season_tables = {"maturity_samples", "harvest_plans", "wine_lots", "cellar_operations", "scouting_observations", "phenology_observations", "labor_entries", "work_activities", "spray_applications"}
