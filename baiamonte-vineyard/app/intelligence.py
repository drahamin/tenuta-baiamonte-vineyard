...
def _damage_event_photo_prompt(
    ...
    return (
        ...
        "chronological object for every source report after the original quantitative determination, with report_id, date, "
        "estimate_pct, low_pct, high_pct, change_from_prior_pct_points, confidence, and rationale. Each estimate is the "
        "revised event-wide posterior after adding that report—not a standalone photo percentage and not a compounded loss. "
