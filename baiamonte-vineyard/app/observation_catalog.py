...
SCOUTING_ISSUES: tuple[dict[str, Any], ...] = (
    ...
    {"code": "olive_fly_trap_activity", "label": "Olive fruit fly · trap activity", "pipelines": ("treatment_prediction",)},
    {"code": "olive_fly_fruit_damage", "label": "Olive fruit fly · fruit stings / damage", "pipelines": ("treatment_prediction",)},
    {"code": "olive_peacock_spot", "label": "Olive peacock spot · leaf symptoms", "pipelines": ("treatment_prediction",)},
