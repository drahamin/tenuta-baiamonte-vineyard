...
def display_payload(year: int | None = None) -> dict[str, Any]:
    ...
    return json_ready({
        ...
        "display": {
            ...
            "adsb_zoom_level": min(12, max(-6, int(runtime_option("tv_adsb_zoom_level", settings.tv_adsb_zoom_level)))),
            "ais_zoom_level": min(12, max(-6, int(runtime_option("tv_ais_zoom_level", settings.tv_ais_zoom_level)))),
