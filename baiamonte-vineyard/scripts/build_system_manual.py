...
def cover(canvas, doc, logo: Path) -> None:
    ...
    canvas.drawString(24 * mm, 74 * mm, "Release covered 1.4.24")
    canvas.drawString(24 * mm, 66 * mm, "Manual date 19 August 2026")
...
def body_page(canvas, doc) -> None:
    ...
    canvas.drawString(21 * mm, height - 13 * mm, "TENUTA BAIAMONTE · SYSTEM MANUAL · RELEASE 1.4.24")
